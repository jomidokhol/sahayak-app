...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivCatIcon,
      @NonNull TextView tvCatName) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((MaterialCardView) rootView, ivCatIcon, tvCatName);
    }
